...
> [!IMPORTANT]
> This repo is now deprecated in favour of the [macpit](https://github.com/macpit/Home-Assistant-Switch-Manager) repo. Much respect to @macpit for picking this up as I have pushed this project to the side. 

> Continue reading if you want my take and insight. I had spent many years on this project which I was very excited about and trying to implement something which I felt Home Assistant would eventually do themselves, alas this did not happen. Development became more of chore as the Home Assistant team has some ADHD issues where they need to change things on almost every update breaking the tiniest of things (this is a well known issue in regards to their development and constant unnecessary changes). I have also on occasions found their moderations on forums etc to be very toxic which also dimished my care for this project. Ultimately, I had other life things going on and I didn't want to keep coming back and studying all the changes Home Assistant had made and keep fixing things when everything was working good and there was no reward in doing so. But in the end it was my hope that the community could eventually pick up from what I started building to continue giving it life as I find it a very convenient integration for switches. So again, credit to @macpit and hope he enjoys doing this more than I did in the end.
